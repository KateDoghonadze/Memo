...
import com.kd.memo.MyDialog;
import com.kd.memo.R;
import com.kd.memo.Utils;
...
public class MyIntentService extends IntentService {
    ...
    private void handleStart() {
        ...
        chatheadView = (RelativeLayout) inflater.inflate(R.layout.memo_layout, null);
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (inBounded) {
                            ...
                            stopService(new Intent(MyIntentService.this, MyIntentService.class));
                            inBounded = false;
                            break;
                        }
